...
<!-- saved from url=(0036)http://login.haodou.com/register.php -->
...
<link rel="stylesheet" type="text/css" href="./regist_files/saved_resource">
<script async="" src="./regist_files/105.js.下载" id="sd-collina-acjs"></script><script type="text/javascript" class="nc-required-js-1 nc-umid-script" src="./regist_files/um.js.下载"></script><script type="text/javascript" class="nc-required-js-1 nc-uab-script" src="./regist_files/uac.js.下载"></script><script type="text/javascript" src="./regist_files/saved_resource(1)"></script>
<link type="text/css" href="./regist_files/nc.css" rel="stylesheet" disabled="">
<script type="text/javascript" src="./regist_files/nc.js.下载"></script><style>@charset "utf-8";
...
<div class="warpb clearfix">
	...
	<div class="regbox">
		<h1>注册通行证</h1>
				<div class="box">
			<form class="reg_main">
				<p class="all_prompt f14 pdb10" id="reg-switcher"><a class="green" href="javascript:///" title="手机号注册" data-reg-by="mobile">手机号注册</a></p>
				<div id="reg_fields_mobile">
				<div class="flex_row">
					<span class="grid_name">手机号：</span>
					<div class="grid_input"><input class="inptx" name="mobile" id="mobile_account" type="text" placeholder="请输入您常用的手机号码" value="" data-tip=""></div>
					<p class="side_prompt"></p>
				</div>
				<div class="flex_row">
					<div class="ln">
						<div id="dom_id" class="nc-container" data-nc-idx="1">
...
<div id="nc_1__voice" class="nc_voice"></div>
				...
				<div class="grid_txt">
					...
					<a class="dbtn btn_gray" id="btn_send_sms1" data-left="3" href="javascript:///" title="免费获取校验码">免费获取校验码</a>
				</div>
				</div>
				<div class="flex_row">
				...
				<div class="flex_row">
					...
					<div class="grid_input"><input class="inptx" name="nick" type="text" id="mobile_nickname" placeholder="不超过8个汉字或16个字母" data-tip="让更多的豆友认识你" value=""></div>
					<p class="side_prompt"></p>
				</div>
				<div class="flex_row">
				...
				<div class="btn_box">
					<input name="同意协议并注册" type="button" id="btn_register" value="同意协议并注册" class="btn_green dbtn long">
					<input type="hidden" id="redirect" value="http%3A%2F%2Fwo.haodou.com%2Fprofile.php%3Fstep%3D1">
					<input type="hidden" id="product" value="1">
					<input type="hidden" id="invite" value="">
				</div>
				<div class="flex_row">
					<span class="grid_name">&nbsp;</span>
			...
			<div class="reg_side">
				<p>已有账号？<a class="green" href="http://login.haodou.com/index.php?referer=http%3A%2F%2Fwo.haodou.com%2Fprofile.php%3Fstep%3D1" title="立即登录">立即登录！</a></p>
				<p class="mgt20">使用以下账号快速登录：</p>
				<div class="other_login clearfix">
					<a class="ico32 gl_sina" href="http://login.haodou.com/call.php?do=connect&amp;site=3&amp;action=bind&amp;product=1&amp;referer=http%253A%252F%252Fwo.haodou.com%252Fprofile.php%253Fstep%253D1" title="微博登录">&nbsp;</a>
					<a class="ico32 gl_tencent" href="http://login.haodou.com/call.php?do=connect&amp;site=6&amp;action=bind&amp;product=1&amp;referer=http%253A%252F%252Fwo.haodou.com%252Fprofile.php%253Fstep%253D1" title="QQ登录">&nbsp;</a>
				</div>
...
.nc-container.tb-login .errloading, .nc-container .errloading {width:290px;}</style><script>
	

jQuery(document).ready(function(){
	var nc = new noCaptcha();
	var nc_appkey = 'FFFF0000000001769C62';  // 应用标识,不可更改
...
//        trans: '{"name1":"code100"}',//测试用，特殊nc_appkey时才生效，正式上线时请务必要删除；code0:通过;code100:点击验证码;code200:图形验证码;code300:恶意请求拦截处理
	...
	$('#btn_send_sms1').on('click', function(e){
		// 手机号码合法
	    if (!$("#mobile_account").parent().siblings(".side_prompt").find("i").hasClass('ico_right')){
	        alert('手机号无效');
			return false;
	    }

		var params = {"csessionid":document.getElementById('csessionid').value,'sig':document.getElementById('sig').value,'token':document.getElementById('token').value ,'scene':document.getElementById('scene').value,"mobile":document.getElementById('mobile_account').value};
	...
	<div class="warpb clearfix">
		...
		<dl class="xf_box">
			...
			<dd class="box">
				...
				<div class="fl frame">
					<iframe scrolling="no" frameborder="0" style="width:400px;height:30px;border:none;overflow:hidden;" border="0" allowtransparency="true" src="./regist_files/like.html"></iframe>
				</div>
			</dd>
		</dl>
		<dl class="xf_box">
		...
		<p class="xf_ver">
            © 2009-2016 <a class="gray9" href="http://www.haodou.com/">好豆网</a> All Rights Reserved.
            <br>湘ICP备B2-20080075-3
            <br><a target="_blank" href="http://img4.hoto.cn/public/images3/beian.jpg">长公网技(备)第43010239000021号</a>
            <br><a target="_blank" href="http://static.hoto.cn/app/www/haodou_yyzz.jpg">湖南红图网络科技有限公司</a>
		</p>
	</div>
</div>
